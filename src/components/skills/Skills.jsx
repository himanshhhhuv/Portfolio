...
const Skills = ({ darkMode }) => {
  return (
    <div id="skills" className="rounded-xl ">
      <div className=" container m-auto  mt-16">
        {/* heading */}
        <div data-aos="fade-up" className="relative mb-5">
          <h3 className=" text-3xl font-black dark:text-white text-gray-400 sm:text-2xl ">
            My Skills
          </h3>
        ...
        <div className="flex md:flex-col ">
          <div className="left flex-1 w-full">
            ...
            <div
              data-aos="zoom-in"
              className="progress flex items-center h-[100%] justify-end md:justify-center dark:text-white">
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                ...
                <ProgressBar logo={<SiMongodb />} name={"Mongodb"} value={77} />
                ...
                <ProgressBar
                  ...
                  value={80}
                />
                <ProgressBar logo={<FaFigma />} name={"Figma"} value={68} />
              </div>
            </div>
          </div>
          {/* right box */}
        ...
        {/* icons */}
        {
          <div
            ...
            className=" container  dark:text-white m-auto flex items-center justify-center mt-8 gap-8 md:gap-5">
            <img
              className="w-[40px] h-[40px] md:w-[35px] md:h-[35px]"
              src="https://img.icons8.com/color/48/null/python--v1.png"
            />
            <img
              className="w-[40px] h-[40px] md:w-[35px] md:h-[35px] dark:invert"
